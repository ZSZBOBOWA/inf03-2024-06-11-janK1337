...
<body>
    ...
    <section class="lewyGlowny">
        <img src="american.jpg" alt="Świnka morska rasy crested">
        <?php 
            $wynik2=$polaczenie->query('SELECT DISTINCT data_ur, miot, rasa FROM swinki JOIN rasy ON rasy_id = rasy.id WHERE rasy.id = 7;');
        ...
        <?php 
            $wynik2=$polaczenie->query('SELECT imie, cena, opis FROM swinki WHERE rasy_id = 7;');
